...
- [Containerized Storage for Containers](/1.0.0-RC1/docs/next/features.html#containerized-storage-for-containers)
- [Synchronous replication](/1.0.0-RC1/docs/next/features.html#synchronous-replication)
- [Snapshots and clones](/1.0.0-RC1/docs/next/features.html#snapshots-and-clones)
- [Backup and Restore](/1.0.0-RC1/docs/next/features.html#backup-and-restore)
- [Prometheus metrics and Grafana graphs](/1.0.0-RC1/docs/next/features.html#prometheus-metrics-for-workload-tuning)



<font size="6">OpenEBS Benefits</font>

- [Granular policies per stateful workload](/1.0.0-RC1/docs/next/features.html#granular-policies-per-stateful-workload)

- [Avoid Cloud Lock-in](/1.0.0-RC1/docs/next/features.html#avoid-cloud-lock-in)
- [Reduced storage TCO upto 50%](/1.0.0-RC1/docs/next/features.html#reduced-storage-tco-upto-50)
- [Native Hyperconvergence on Kubernetes](/1.0.0-RC1/docs/next/features.html#native-hyperconvergence-on-kubernetes)
- [High availability - No Blast Radius](#high-availability)
- [Free cross cloud visibility of stateful applications](/1.0.0-RC1/docs/next/features.html#free-cross-cloud-visibility-of-stateful-applications)



For more information on how OpenEBS is used in cloud native environments,  visit the [use cases](/1.0.0-RC1/docs/next/usecases.html) section.
...
### [Object Storage with OpenEBS](/1.0.0-RC1/docs/next/minio.html)

### [RWM PVs with OpenEBS](/1.0.0-RC1/docs/next/rwm.html)

### [Local storage for Prometheus ](/1.0.0-RC1/docs/next/prometheus.html)
