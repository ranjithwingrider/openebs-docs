...
For using real disks, you have to create [cStorPools](/1.0.0-RC1/docs/next/configurepools.html) or [Jiva pools](/1.0.0-RC1/doc/next/jivaguide.html#create-a-jiva-pool) or [OpenEBS Local PV](/1.0.0-RC1/docs/next/uglocalpv.html) based on the requirement and then create correspodniong StorageClasses or use default StorageClasses to use them.
