...
- Installation [troubleshooting](/1.0.0-RC1/docs/next/troubleshooting.html#installation) 
...
iSCSI client is a pre-requisite for provisioning cStor and Jiva volumes. However, it is recommended that the [iSCSI client is setup](/1.0.0-RC1/docs/next/prerequisites.html) and iscsid service is running on worker nodes before proceeding with the OpenEBS installation.
...
For using real disks, you have to create [cStorPools](/1.0.0-RC1/docs/next/ugcstor.html#creating-cStor-storage-pools) or [Jiva pools](/1.0.0-RC1/doc/next/jivaguide.html#create-a-jiva-pool) or [OpenEBS Local PV](/1.0.0-RC1/docs/next/uglocalpv.html) based on the requirement and then create correspodniong StorageClasses or use default StorageClasses to use them.



To monitor the OpenEBS volumes and obtain corresponding logs, connect to the free SaaS service MayaOnline. See connecting to [MayaOnline](/1.0.0-RC1/docs/next/mayaonline.html). 
...
### [Installation troubleshooting](/1.0.0-RC1/docs/next/troubleshooting.html)
