...
Select or <a href="/1.0.0-RC1/docs/next/ugcstor.html#creating-cStor-storage-pools">create a cStor pool</a> that satisfies the performance, and availability requirements

<br>

**Select or create a cStor storage Class**

<a href="/1.0.0-RC1/docs/next/ugcstor.html#creating-cStor-storage-class">Create a storage class</a> to point to the above selected pool and also select number of replicas and default size of the volume
...
### [cStorPools](/1.0.0-RC1/docs/next/ugcstor.html#creating-cStor-storage-pools)

### [Setting up Object Storage](/1.0.0-RC1/docs/next/minio.html)
