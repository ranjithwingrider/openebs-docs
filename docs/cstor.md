...
- RAID type within the pool (currently stripe and mirror are supported). Refer to the [cStor Pool roadmap](/1.0.0-RC1/docs/next/cstor.html#cstor-roadmap) to find the status of RAIDz1 support

**Number of pools:** It is good to start with 3 pools as the number of volume replicas will be typically three or one. However, the number of pools are fixed in OpenEBS 0.8 version. Support for increasing the pool replicas on the fly is in the [cStor Pool roadmap](/1.0.0-RC1/docs/next/cstor.html#cstor-roadmap)  . At the time of cStor pool creation, individual and independent pools are created on the specified nodes. 
...
**Add a new pool instance** : (Not supported in OpenEBS 0.8, refer to the  [cStor roadmap](/1.0.0-RC1/docs/next/cstor.html#cstor-roadmap). A new pool instance may need to be added for many different reasons. Few example scenarios  are:
...
[Pool topology view](/1.0.0-RC1/docs/next/mayaonline.html#cstor-pool-view)

[Volume POD topology view](/1.0.0-RC1/docs/next/mayaonline.html#cstor-volume-pod-view)

[Volume CR topology view](/1.0.0-RC1/docs/next/mayaonline.html#cstor-custom-resources-view)
...
1. **iSCSI tools are not installed or iSCSI.d service is not running**
   ...
   **Resolution**: 
   ...
   Install iSCSI tools and make sure iSCSI service is running. See [iSCSI installation](/1.0.0-RC1/docs/next/prerequisites.html)
...
2. **Multi-attach error is seen in the logs**
   ...
   **Resolution :**
   ...
   This is because of the Kubernetes limitation [explained above](/1.0.0-RC1/docs/next/cstor.html#known-limitations). OpenEBS CSI driver will resolve this issue. See [roadmap](/1.0.0-RC1/docs/next/cstor.html#cstor-roadmap). In this situation if the node is stuck in a non-responsive state and if the node has to be permanently deleted, remove it from the cluster.  
...
### [Storage Engines in OpenEBS](/1.0.0-RC1/docs/next/storageengine.html)

### [Creating cStor Pool](/1.0.0-RC1/docs/next/configurepools.html)

### [Provisioning cStor volumes](/1.0.0-RC1/docs/next/deploycstor.html)
